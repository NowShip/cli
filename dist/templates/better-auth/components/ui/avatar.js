...
const AvatarFallback = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<AvatarPrimitive.Fallback ref={ref} className={cn("bg-gray-light flex h-full w-full items-center justify-center rounded-full capitalize", className)} {...props}/>);
});
