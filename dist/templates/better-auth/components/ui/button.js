...
const buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        variant: {
            default: "bg-contrast-higher text-background hover:bg-contrast-higher/90",
            primary: "bg-linear-to-t from-primary to-primary-dark shadow-sm text-black hover:opacity-90 inset-ring inset-ring-white/20 inset-shadow-[1px_1px_0px_hsl(0_0%_100%/.3)]",
            destructive: "bg-red text-white hover:bg-red/90",
            outline: "border bg-background hover:bg-contrast-lower/20",
            secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
            ghost: "bg-contrast-lower/20 text-dark hover:bg-contrast-lower/10",
...
const Button = React.forwardRef((_a, ref) => {
    var { className, variant, size, href, asChild = false } = _a, props = __rest(_a, ["className", "variant", "size", "href", "asChild"]);
    if (href) {
