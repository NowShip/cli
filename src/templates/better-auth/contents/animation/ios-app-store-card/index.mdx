...
description: A simple app store card component for iOS - Built with Motion.
video: https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblt7yX4rQSzao8JKyu7h1mvi6bR3WYqeXkUV9Z
price: 50
---
...
<Preview name="animation-ios-app-store-card" />
