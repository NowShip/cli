---
title: FAQ Spring
description: A simple FAQ component with spring animation - Built with Motion.
video: https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblh8OHGeCQv3Atr4RaOyluoU9L5K8Hj2c716Fk
price: 199
---
...
<Preview name="animation-faq-spring" className="min-h-100 items-center" />

Inspiration: [@nitishkmrk](https://x.com/nitishkmrk)
