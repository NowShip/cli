---
title: Theme Toggle
description: A theme toggle component - Built with Motion.
video: https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblJ30jOHppCLoeWTwm1FMjXbhRqOVzG6KH4rxy
price: 199
---
...
<Preview name="animation-theme-toggle" className="h-[500px]" />

Inspiration: [@dzzgnr](https://x.com/dzzgnr)
...
<UsedComponents name="iphone-simulator" />
...
<Video
  src="https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblkwqopWchgaVfydoMRxJpsBzICvEUOTZGeik1"
  placeholder="Using spring transition makes it feel more natural but I was getting the following issue with theme component being flickering. So I decided to use cubic-bezier(0.85, 0, 0.15, 1) instead."
/>
