  ...
  return (
    <Content>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {sortMotionBySlug(allAnimations).map((motion) => (
          <Link
            key={motion._id}
            href={`${motion.slug}`}
            className="group overflow-hidden rounded-xl border shadow-lg transition-all duration-300 hover:-translate-y-1"
          >
            <div className="p-4">
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {allReusableComponents.map((motion) => (
            <Link
              key={motion._id}
              href={`${motion.slug}`}
              className="group bg-background rounded-xl border shadow-lg transition-all duration-300 hover:-translate-y-1"
            >
              <div className="p-4">
                <h3 className="text-lg font-medium">{motion.title}</h3>
                <p className="text-muted line-clamp-1 text-sm">
      ...
      <div className="my-12">
        ...
        <ul className="mt-4 space-y-2 pl-4">
          ...
          <li>
            ...
            <Image
              src="https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblXc4H2XuUhWzB7osHN9QI2eSyxcK5Cbntr4Rd"
              alt="code"
              width={700}
              height={500}
          ...
          <li>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Image
                src="https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblAKrEXwAWnwPu9qoySDWO51eG3Uzhf6c2bjvN"
                alt="code"
                width={700}
                height={500}
                className="mt-4 w-full rounded-2xl border"
              />
              <Image
                src="https://vztpjn0djt.ufs.sh/f/RAHCy45jEyblTjvG1xkVcSk9xCE6vmYKByetqajiVO07pnNg"
                alt="code"
                width={700}
                height={500}
                className="mt-4 w-full rounded-2xl border"
