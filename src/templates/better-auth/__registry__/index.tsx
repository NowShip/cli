...
> = {
  "animation-checkbox-and-submit": {
    name: "submit",
    component: dynamic(
      () => import("@/contents/animation/checkbox-and-submit/main"),
      {
        ssr: false,
      }
    ),
...
`,
  ...
  "animation-ios-app-store-card": {
    name: "card",
    component: dynamic(
      () => import("@/contents/animation/ios-app-store-card/main"),
      {
        ssr: false,
      }
    ),
...
`,
  ...
  "reusable-components-infinite-move-preview": {
    name: "preview",
    component: dynamic(
      () => import("@/contents/reusable-components/infinite-move/preview"),
      {
        ssr: false,
      }
    ),
...
`,
  ...
  "reusable-components-video-explains-aspect-ratio": {
    ...
    component: dynamic(
      () =>
        import("@/contents/reusable-components/video/explains/aspect-ratio"),
      {
        ssr: false,
      }
    ),
...
`,
  ...
  "reusable-components-video-explains-data-active": {
    name: "active",
    component: dynamic(
      () => import("@/contents/reusable-components/video/explains/data-active"),
      {
        ssr: false,
      }
    ),
...
`,
  ...
  "reusable-components-video-preview": {
    name: "preview",
    component: dynamic(
      () => import("@/contents/reusable-components/video/preview"),
      {
        ssr: false,
      }
    ),
...
> = {
  "iphone-simulator": {
    name: "simulator",
    component: dynamic(
      () => import("@/components/main-components/iphone-simulator"),
      {
        ssr: false,
      }
    ),
